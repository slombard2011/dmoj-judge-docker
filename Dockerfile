...
RUN apt-get install -y sudo wget curl apt git python-dev python-pip python3 build-essential mono-complete openjdk-8-jdk ruby php ghc clang libicu-dev nano ninja-build debconf-utils gnupg gcc g++ make libxml2-dev libxslt1-dev zlib1g-dev gettext openssl ruby ruby-dev gem scala
